def printp(final_hash):
    pretty = ""
    for letter in final_hash:
        pretty += letter
    print(pretty)
    print("for info about SHA-2 please visit https://en.wikipedia.org/wiki/SHA-2")
    print("CHALLLENGE: Crack the following hash abbb6d565c887a31a208e6a276a5510692434ec9777c2fd112a0d9ba4fd67e")
...
def sha_256(input_string):
    ...
    printp(final_hash)
    return(final_hash)
input_string = input("Encrypt your password with Wensdays SHA-256")
sha_256(input_string)
